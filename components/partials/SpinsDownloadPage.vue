...
function updateVerify(art) {
  ...
  let edition =
    art.format == "iso" ? "Fedora-Spins-iso" : "Fedora-Spins-images";
  if (betaSwitch.value) {
    // Beta
    ...
    // Fedora-Spins-37_Beta-1.5-x86_64-CHECKSUM
    ...
    // Fedora-Spins-37-1.7-x86_64-CHECKSUM
    ...
    <section class="px-2 pt-24 pb-12 text-center lg:text-start">
      <div class="container mx-auto max-w-7xl px-2">
        ...
        <p class="text-gray-600 dark:text-fp-gray-light">
          {{ $t(data.downloadSection.description) }}
        </p>
        <div class="mt-5 flex">
          <p
