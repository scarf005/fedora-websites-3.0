...
<template>
  <nav class="fixed z-50 w-full bg-fp-blue">
        ...
        <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
          ...
          <div class="hidden sm:ml-auto sm:block">
            <div class="flex space-x-4">
              <a class="inline-flex cursor-pointer items-center rounded px-4 text-sm text-white"
    ...
    <div :class="showMenu ? 'flex': 'hidden'" id="mobile-menu">
      <div class="space-y-1 px-2 pt-2 pb-3">
        <a class="inline-flex cursor-pointer items-center rounded px-3 py-2 text-sm text-white"
          href="https://docs.fedoraproject.org/en-US/project/">
