<script setup>
import { EC2_regions } from "../../config/cloud.js";
const { t } = useI18n();
...
<template>
  <main
    class="border-t-8 border-fp-magenta bg-neutral-100 dark:bg-neutral-800"
    ...
    >
      ...
      >
        ...
        >
          <li>
            <i18n-t
              keypath="download_the_checksum_and_signature"
              tag="p"
              class="mb-2"
            >
