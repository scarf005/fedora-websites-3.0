...
function updateVerify(art) {
  ...
  if (betaSwitch.value) {
    // Beta
    verifyModal.value.chk_name = `Fedora-Kinoite-${release_data._value.beta.releasever}_Beta-${release_data._value.beta.rc_version}-${art.arch}-CHECKSUM`;
    ...
    verifyModal.value.chk_name = `Fedora-Kinoite-${release_data._value.ga.releasever}-${release_data._value.ga.rc_version}-${art.arch}-CHECKSUM`;
  ...
  <main class="border-t-8 border-fp-newblue dark:bg-neutral-800 md:mt-1">
    ...
    >
      ...
      <div class="container mx-auto my-8 max-w-7xl">
        ...
        >
          <template
            v-if="betaSwitch == false && ga_data?.payload.images.Kinoite"
          >
            <DownloadSection
            ...
            <DownloadSection
              ...
              @verify-click="updateVerify"
              :artifacts="
                ga_data.payload.images.Kinoite.aarch64 ||
                backup.data.value.payload.images.Kinoite.aarch64
              "
