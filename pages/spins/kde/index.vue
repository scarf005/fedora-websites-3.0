...
<template>
  <main class="border-t-8 border-fp-newblue dark:bg-neutral-800 md:mt-2">
    <TheLocalBar
      :image="{
        light: 'assets/images/spins/spins-kde-logo-light.png',
        dark: 'assets/images/spins/spins-kde-logo-dark.png',
      }"
      home="/spins/kde"
      textColor="text-fp-newblue"
      :items="[{ name: 'Download', link: '/spins/kde/download' }]"
    />
    ...
    <section class="relative z-0 dark:bg-black">
      ...
      <FpCallToAction
        :cta="data.links"
        :image="{
          light: 'assets/images/spins/spins-kde-light.png',
          dark: 'assets/images/spins/spins-kde-dark.png',
        }"
      />
    </section>
  </main>
