<script setup>
const data = await getCMS("spins/budgie/home");
useContentHead(data);
...
<template>
  <main class="border-t-8 border-fp-newblue dark:bg-neutral-800 md:mt-2">
    <TheLocalBar
      :image="{
        light: 'assets/images/spins/spins-Budgie-logo-light.png',
        dark: 'assets/images/spins/spins-Budgie-logo-dark.png',
      }"
      home="/spins/budgie"
      textColor="text-fp-newblue"
      :items="[{ name: 'Download', link: '/spins/budgie/download' }]"
    />
    ...
    <section class="relative z-0 dark:bg-black">
      ...
      <FpCallToAction
        :cta="data.links"
        :image="{
          light: 'assets/images/spins/spins-budgie-light.png',
          dark: 'assets/images/spins/spins-budgie-dark.png',
        }"
      />
    </section>
  </main>
