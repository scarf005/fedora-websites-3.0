...
function updateVerify(art) {
  ...
  if (betaSwitch.value) {
    // Beta
    verifyModal.value.chk_name = `Fedora-Everything-${release_data._value.beta.releasever}_Beta-${release_data._value.beta.rc_version}-${art.arch}-CHECKSUM`;
    ...
    verifyModal.value.chk_name = `Fedora-Everything-${release_data._value.ga.releasever}-${release_data._value.ga.rc_version}-${art.arch}-CHECKSUM`;
      ...
      <div class="container mx-auto max-w-7xl px-2">
        <h1 class="mb-4 text-4xl text-gray-600 dark:text-gray-200">
          ...
          <span class="text-fp-newblue" v-if="betaSwitch == false">
            {{ $t("Fedora Everything") }} {{ release_data.ga.releasever }}</span
          >
          <span class="text-fp-newblue" v-else>
            {{ $t("Fedora Everything") }} {{ release_data.beta.releasever }}
            {{ $t("BETA").toLowerCase() }}
          </span>
        </h1>
        ...
        >
          <template v-if="betaSwitch == false && ga_data?.payload">
            <DownloadSection
              ...
              art_name="Fedora Everything"
              @verify-click="updateVerify"
              :artifacts="ga_data.payload.images.Everything.x86_64"
            ...
            <DownloadSection
              ...
              art_name="Fedora Everything"
              @verify-click="updateVerify"
              :artifacts="ga_data.payload.images.Everything.aarch64"
            ...
            <DownloadSection
              ...
              art_name="Fedora Everything"
              @verify-click="updateVerify"
              :artifacts="ga_data.payload.images.Everything.ppc64le"
            ...
            <DownloadSection
              ...
              art_name="Fedora Everything"
              @verify-click="updateVerify"
              :artifacts="ga_data.payload.images.Everything.s390x"
          ...
          <template v-else-if="betaSwitch == true && beta_data?.payload">
            <DownloadSection
              ...
              art_name="Fedora Everything"
              @verify-click="updateVerify"
              :artifacts="beta_data.payload.images.Everything.x86_64"
              :dlPrefix="dlpath.x86_64"
            ...
            <DownloadSection
              ...
              art_name="Fedora Everything"
              @verify-click="updateVerify"
              :artifacts="beta_data.payload.images.Everything.aarch64"
              :dlPrefix="dlpath.aarch64"
              :version="release_data.beta.releasever"
              class="spins-theme"
              isBeta
            ...
            <DownloadSection
              ...
              art_name="Fedora Everything"
              @verify-click="updateVerify"
              :artifacts="beta_data.payload.images.Everything.ppc64le"
              :dlPrefix="dlpath.ppc64le"
              :version="release_data.beta.releasever"
              class="spins-theme"
              isBeta
            ...
            <DownloadSection
              ...
              art_name="Fedora Everything"
              @verify-click="updateVerify"
              :artifacts="beta_data.payload.images.Everything.s390x"
              :dlPrefix="dlpath.s390x"
              :version="release_data.beta.releasever"
              class="spins-theme"
              isBeta
