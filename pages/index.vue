...
<template>
  ...
  <h1 class="text-center mt-8">{{data.header.title}}</h1>
  ...
  <main class="mx-6 md:mx-12 text-center">
    ...
    <section class="large-section">
      ...
      <div class="my-4 flex flex-wrap gap-4 lg:gap-8 justify-center">
        ...
        <div>
          ...
          <ul class="marker:text-fp-blue marker:text-2xl">
            <li>An item</li>
            <li>An item</li>
            <li>An item</li>
          </ul>
    ...
    <section class="large-section flex flex-col items-center">
      ...
      <div
        class="grid grid-cols-2 md:grid-cols-4 w-full md:w-1/2 my-4 items-center"
      >
        <h4 class="col-span-full text-center mb-2">Buttons</h4>
        <p class="col-span-full text-center mb-4">
