    ...
    <main class="mx-6 md:mx-12 text-center">
      ...
      <section class="large-section">
        <header class="section-header">
          <h2 class="font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-fp-blue to-fp-purple">Non Heading
            Text</h2>
        </header>
      ...
      <section class="large-section flex flex-col items-center">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 w-full md:w-1/2 my-4 items-center">
          ...
          <FpBtn>Default</FpBtn>
          <FpBtn color="bg-fp-magenta hover:bg-fp-magenta/[0.6]">bg-magenta</FpBtn>
