...
<template>
  <main class="w-full">
    <header
      class="to-fp-blue-light flex min-h-screen flex-col bg-gradient-to-b from-fp-blue pt-16 text-white"
    >
      <section
    ...
    <div class="w-full bg-gray-100 dark:bg-gray-900">
      <div class="mx-auto grid max-w-5xl grid-cols-2 py-5">
        <FpLink v-for="item in data.sections[3].content" :href="item.url">
          ...
          >
            <h2
              class="to-fp-blue-light mb-12 bg-gradient-to-r from-fp-green bg-clip-text text-center text-xl font-bold text-transparent lg:text-5xl"
            >
              {{ $t(item.title) }}
            </h2>
